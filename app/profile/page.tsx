    ...
    <div>
      ...
      <div className='app_container mb-10'>
        ...
        <div className={`${styles.about}`}>
          <h4>About me</h4>
          <div>
            <div className={`${styles.about_info} space-y-5`}>
              <div>
              <p>
              Welcome to my page! This is where I share a little about myself. Whether it’s my passions, experiences, or the things that inspire me, this space is all about who I am and what I do.
              </p>
              <div className={styles.edit_button}>
                <Image src='/profile-edit-button.svg' width={25} height={25} alt="profile edit button" />
              </div>
              </div>
